...
const CricketIconSvg = (props: React.SVGProps<SVGSVGElement>) => (
...
const BadmintonIconSvg = (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} viewBox="0 0 24 24" fill="currentColor">
...
const FootballIconSvg = (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} viewBox="0 0 24 24" fill="currentColor">
...
const TennisIconSvg = (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} viewBox="0 0 24 24" fill="currentColor">
...
const TableTennisIconSvg = (props: React.SVGProps<SVGSVGElement>) => (
  <svg {...props} viewBox="0 0 24 24" fill="currentColor">
...
export const SportIcon = ({ sport, className }: { sport: Sport, className?: string }) => {
  const iconMap: Record<Sport, string> = {
    "Cricket": "/cricket.png",
    "Football": "/foot-ball.png",
    "Tennis": "/tennis.png",
    "Table Tennis": "/table-tennis.png",
    "Badminton": "/badminton.png",
  };

  const src = iconMap[sport];

  return <Image src={src} alt={`${sport} icon`} width={20} height={20} className={className} />;
};
