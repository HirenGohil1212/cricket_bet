  ...
  return (
    <Card className="bg-gradient-to-br from-primary/10 to-primary/20 border-primary/20">
      <CardHeader className="flex flex-row items-center gap-4">
        ...
        <div>
            <CardTitle className="font-headline text-lg text-primary">Refer & Earn</CardTitle>
      ...
      <CardContent className="space-y-2">
        ...
        <div className="flex items-center space-x-2">
          <Input readOnly value={referralCode} className="font-mono bg-background text-primary border-primary/30" />
          <Button variant="ghost" size="icon" onClick={handleCopy} disabled={!userProfile?.referralCode} className="text-primary hover:text-primary/80">
