      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
            {fields.map((field, index) => {
                if (!field.playerImageUrl) return null; // Don't render manual add fields here
                return (
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        <Card>
            <CardHeader>
                ...
                <CardDescription>Add the questions users will predict the outcome for. You can set individual multipliers.</CardDescription>
            </CardHeader>
